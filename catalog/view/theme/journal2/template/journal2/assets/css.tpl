...
<?php if($this->journal2->settings->get('product_grid_button_icon_display', 'both') === 'icon' && $this->journal2->settings->get('product_grid_button_block_button', 'block-button') === 'inline-button'): ?>

        ...
        if ($cache === null || self::$CACHEABLE !== true) {
            ...
            switch ($setting['position']) {
                ...
                case 'content_bottom':
                    ...
                    if ($this->journal2->settings->get('extended_layout')) {
                        ...
                        $width = $this->journal2->settings->get('site_width', 1024) - ($cl * $content_padding_left - $cr * $content_padding_right) - ($cl * $column_left_width - $cl * $content_padding_left - $cr * $column_right_width - $cr * $content_padding_right);
                    }
                    $this->data['width'] = "max-width: {$width}px";
                    $this->data['slider_class'] = 'journal-slider';
                    break;
            ...
            foreach ($slides as $slide) {
                ...
                foreach ($captions as $caption) {
                    ...
                    if (Journal2Utils::getProperty($caption, 'position', 'custom') == 'custom') {

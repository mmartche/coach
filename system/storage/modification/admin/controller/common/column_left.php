	...
	public function index() {
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
			...
			*/	
            ...
            // Cielow
            $this->load->language('extension/payment/cielow_menu');

            $cielow = array();

            if ($this->user->hasPermission('access', 'sale/cielow_search')) {
                $cielow[] = array(
                    'name'     => $this->language->get('text_cielow_search'),
                    'href'     => $this->url->link('sale/cielow_search', 'token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }

            if ($this->user->hasPermission('access', 'sale/cielow_error_log')) {
                $cielow[] = array(
                    'name'     => $this->language->get('text_cielow_log_debug'),
            ...
            if ($cielow) {
                $sale[] = array(
                    'name'     => $this->language->get('text_cielow'),
                    'href'     => '',
                    'children' => $cielow
                );
            }
